...
export class DatastreamStaleScheduler {
  ...
  public constructor(
    ...
    private readonly tasks: () => readonly DatastreamStaleTask[],
    private readonly onTaskResult: (result: DatastreamStaleTaskResult) => void = () => undefined,
    private readonly options: DatastreamStaleSchedulerOptions = {},
  ) {}
